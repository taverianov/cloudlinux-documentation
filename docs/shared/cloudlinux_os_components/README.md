...
CloudLinux OS Shared offers JSON API for [lvectl](/shared/command-line_tools/#lvectl) and [cloudlinux-limits](/shared/command-line_tools/#cloudlinux-limits) via WHM. You can access it using the following URL:
