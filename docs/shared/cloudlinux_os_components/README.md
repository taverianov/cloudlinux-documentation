...
* [PHP 4.4 extensions](./#php-4-4-extensions)
...
You can install Python Selector using the [CloudLinux OS Shared Installation Wizard](/shared/lve_manager/#cloudlinux-os-shared-installation-wizard).
...
CloudLinux OS Shared offers JSON API for [lvectl](/shared/command-line_tools/#lvectl) via WHM. You can access it using the following URL:
...
|<span class="notranslate">`handler`</span>|should match [lvectl](/shared/command-line_tools/#lvectl) command|
