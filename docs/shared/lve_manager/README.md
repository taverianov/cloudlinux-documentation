...
<span class="notranslate">CloudLinux Manager</span> is a plugin for most popular control panels including cPanel, Plesk, DirectAdmin, ISPmanager, InterWorx, and CyberPanel. It allows you to control and monitor limits, and set limits on per package bases.
