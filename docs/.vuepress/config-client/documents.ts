export default [
    ...
    {
        title: "CloudLinux OS Legacy",
        description: "CloudLinux OS Legacy is designed for shared hosting providers. It isolates each customer into a separate “Lightweight Virtualized Environment” (LVE), which allocates and limits server resources.",
        link: "/shared/cloudlinux_installation/",
    },
    {
        title: "CloudLinux OS Shared Pro",
        description: "CloudLinux OS Shared Pro extends your CloudLinux OS Legacy functionality with even more useful features.",
